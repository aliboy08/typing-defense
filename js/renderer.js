...
import { COLORS, WORD_COLORS, SHIELD_X, BASE_RADIUS_V, CHAIN_LIGHTNING_DURATION } from './constants.js';
...
export function drawActivePowerUps(activeChainLightning, chainLightningTimer) {
  if (!activeChainLightning) return;
  const pct  = chainLightningTimer / CHAIN_LIGHTNING_DURATION;
  ...
  ctx.fillText('CHAIN LIGHTNING', x, y - 14);
...
export function drawMenu() {
  ...
  drawCentered('Words assault your base from the right.', cy - 8, '16px "Courier New",monospace', '#aa88ff', 10);
